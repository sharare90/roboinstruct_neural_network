...
for _ in range(1000):
    batch_xs, batch_ys = db.next_batch(500, db.data, db.labels)
    batch_v_xs, batch_v_ys = db.next_batch(100, db.valid_data, db.valid_labels)
    ...
    sess.run(train_step, feed_dict={x: batch_v_xs, y_: batch_v_ys, learning_rate: 0.001})
    # if (_ % 200 == 0):
